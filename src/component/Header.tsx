  ...
  return (
    <div>
      <div className="flex w-full h-[70px] border-b justify-center  ">
        ...
        <div className="w-[70px] text-lg items-center justify-center font-bold">Vre<span className="text-green-600 text-[22px]">Tha</span>
        </div>
        <div className="min-w-[40%] flex items-center bg-blue ">
          <div className="mr-8 h-[36%]">Product</div>
          <div  className="mr-8 h-[36%]">Pricing</div>
          <div className="mr-8 h-[36%]">Enterprice</div>
          <div  className="mr-8 h-[36%]">Resources&Support</div>
        </div>
